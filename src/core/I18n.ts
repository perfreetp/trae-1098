...
const locales: Record<Language, LocaleData> = {
  ...
  'en-US': {
    ...
    demo: {
      pageTitle: 'Smart Parking SDK Demo',
      settings: 'Settings',
      theme: 'Theme',
      light: 'Light',
      dark: 'Dark',
      ...
      parkingLotSelector: 'Parking Lot Selector',
      spacePanel: 'Space Panel',
    ...
    findCar: {
      ...
      inputPlaceholder: 'Enter license plate number',
    },
  },
};
